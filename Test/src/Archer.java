...
public class Archer extends Player {
	...
	public void attackProcess(Player p, Graphics g, Graphics g1, ImageObserver frame) {
		...
		} else if (skill0On == false && skill1On == false)
			Draw_human(g1, frame);
		DrawAttack(g, frame);
	}
